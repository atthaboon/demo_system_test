...
namespace demo_system_test
{
    ...
    public class LoginTest
    {
        ...
        public void Login_CorrectUsernameAndPassword_RedirectToProspectPage()
        {
            ...
            // Act
            EnterUsernameAndPasswordLogin("admin", "admin@123");
        ...
        public void Login_IncorrectUsernameAndPassword_DisplayErrorMessage()
        {
            ...
            // Act
            EnterUsernameAndPasswordLogin("admin", "admin@1234");
        ...
        private void EnterUsernameAndPasswordLogin(string username, string password)
        {
